...
@section('title', 'Terms - Omsim')
@section('meta_description', 'Omsim terms of service.')
    ...
    <div class="relative">
        ...
        <main id="main">
            <div class="mx-auto max-w-3xl px-4 py-14 sm:px-6">
                ...
                <h1 class="mt-6 text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">Terms</h1>
